...
La interactividad se basa en mantener presionado el mouse, y este produce resultados distintos según la pantalla. En la pantalla del hombre, el clic activa particulas de aplausos, ondas y validación visual. En la pantalla de la mujer, el clic activa interrupción sonora, fondo rojo, temblor de la boca y figuras aleatorias que también interrumpen. Así, el sistema transforma acciones simples del usuario en una comparación entre una opinión celebrada y validada y una opinión interrumpida. 
